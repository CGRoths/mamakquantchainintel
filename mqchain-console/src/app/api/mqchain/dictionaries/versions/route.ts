...
export async function GET(request: NextRequest) {
  ...
  try {
    const result = await listDictionaryVersionHistory(Object.fromEntries(request.nextUrl.searchParams.entries()));
    ...
    return errorResponse(error instanceof Error ? error.message : "Dictionary version history request failed.", 500);
  }
}
